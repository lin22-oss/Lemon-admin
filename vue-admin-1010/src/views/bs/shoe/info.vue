  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="商品厂商">
        <el-select v-model="shoeInfo.manufacturerId" placeholder="请选择">
          <el-option
      ...
      <el-form-item label="商品简介">
        <tinymce
          :height="400"
          v-model="shoeInfo.description"
          ref="knowledgeText"
        />
      </el-form-item>

      <el-form-item label="商品库存">
        <el-input v-model="shoeInfo.stock" placeholder="0" />
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getVideo() {
      video.getVideo(this.shoeId).then((response) => {
    ...
    //根据商品id查询
    getInfo() {
      shoe.getShoeInfoId(this.shoeId).then((response) => {
    ...
    //查询所有的厂商
    getListManufacturer() {
      shoe.getListManufacturer().then((response) => {
        this.manufacturerList = response.data.items;
      });
    },
    //添加商品
    addShoe() {
      shoe.addShoeInfo(this.shoeInfo).then((response) => {
        //提示
        this.$message({
          type: "success",
          message: "添加商品信息成功!",
    ...
    //修改商品
    updateShoe() {
      shoe.updateShoeInfo(this.shoeInfo).then((response) => {
        //提示
        this.$message({
          type: "success",
          message: "修改商品信息成功!",
